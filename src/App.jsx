...
function App() {
  ...
  const contextPrompt = `As an AI LinkedIn post creator, generate engaging, professional content optimized for the platform. Focus on delivering value to the audience.`;
      ...
      <div className="flex space-y-4 justify-envenly px-[8%] pt-10">
        ...
        <div className="flex space-x-4">
          <button 
            ...
            className={`px-4 py-2 rounded ${postStyle === "standard" ? "bg-blue-500 text-white" : "bg-gray-200"}`}
          >
            Standard
          </button>
          <button 
            onClick={() => setPostStyle("concise")}
            className={`px-4 py-2 rounded ${postStyle === "concise" ? "bg-blue-500 text-white" : "bg-gray-200"}`}
          >
            Concise
          </button>
          <button 
            onClick={() => setPostStyle("elaborate")}
            className={`px-4 py-2 rounded ${postStyle === "elaborate" ? "bg-blue-500 text-white" : "bg-gray-200"}`}
          >
            Elaborate
          </button>
        </div>
