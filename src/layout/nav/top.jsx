...
import { signOut } from "@/reducers/googleSigninSlice";
                ...
                <NavigationMenuLink>
                  <div className="min-w-40 flex flex-col min-h-20 p-2">
                    <button
                      ...
                      className="py-0.5 flex justify-center items-center px-3 w-full text-gray-50 bg-teal-500 rounded-md"
                    >
                      Signout
                      <svg
            ...
            <SheetHeader>
              ...
              <SheetDescription>
                <div className="flex-col w-full h-full py-6">
                  ...
                  <h2 className="ml-6 text-sm font-semibold mb-3 mt-5 text-start uppercase">
                    Tools
                  </h2>
                  <NavLink
                    to="generate"
